...
function Deleteuser(){
    fetch(`https://fathomless-atoll-56036.herokuapp.com/show-user/${idStorage.getItem('username')}`,{
        method: "GET",
        body: JSON.stringify(),
        headers: {
...
fetch('https://fathomless-atoll-56036.herokuapp.com/get-products/')
.then(res => res.json())
.then(data =>{
    products = data
    console.log(data)
...
fetch(`https://fathomless-atoll-56036.herokuapp.com/show-user/${mystorage.getItem('username')}`,{
    method: "GET",
    body: JSON.stringify(),
    headers: {
        'Content-type': 'application/json',
...
function addClicked(id){
    fetch(`https://fathomless-atoll-56036.herokuapp.com/get-product/${id}/`, {
                method: "GET",
                body: JSON.stringify(),
                headers: {
                    'Content-type': 'application/json',
