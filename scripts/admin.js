...
.then(data =>{
    ...
    function update(){
        fetch(`https://fathomless-atoll-56036.herokuapp.com/edit-product/${idstored.getItem('product_id')}/`, {
            method: "PUT",
            body: JSON.stringify({
...
function convert(){
  ...
  function create(){
    ...
    fetch('https://fathomless-atoll-56036.herokuapp.com/products-create/', {
        method: "POST",
        body: JSON.stringify({
            'item_name': document.querySelector('#item_name').value,
            'description':  document.querySelector('#description').value,
